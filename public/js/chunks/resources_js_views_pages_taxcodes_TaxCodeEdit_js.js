...
var _excluded = ["async", "invalid", "defaultOptions", "optionLabel", "optionValue", "defaultValue", "options", "url", "filter", "onChange", "urlParams", "value", "innerRef"];
...
var SearchSelect = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.forwardRef(function (_ref, ref) {
  ...
  var loadOptions = function loadOptions(inputValue, callback) {
    axios__WEBPACK_IMPORTED_MODULE_3___default().get(url, {
      ...
      if (callback) {
        var _options = response.data.data;
        callback(_options);
      }
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_containers_MasterEdit__WEBPACK_IMPORTED_MODULE_0__.default, {
    ...
    onOpen: function onOpen(response) {
      if (response) {
        ...
        if (data.id) {
          ref.current.getRef('account_id').setSelected({
            id: data.account_id,
