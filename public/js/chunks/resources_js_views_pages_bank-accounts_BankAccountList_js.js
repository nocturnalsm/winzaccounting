...
var BankAccountList = function BankAccountList() {
  var tableData = JSON.parse(localStorage.getItem('datatable.bankaccountslist')) || {};
  ...
  var handleDelete = function handleDelete(data, clickEvent) {
    _alert__WEBPACK_IMPORTED_MODULE_3__.default.confirm({
      ...
      confirmAction: function confirmAction() {
        axios__WEBPACK_IMPORTED_MODULE_4___default().delete('/api/setup/bank-accounts/' + data.id).then(function () {
