...
var UnitEdit = function UnitEdit(props) {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null),
      _useState2 = _slicedToArray(_useState, 2),
      perUnit = _useState2[0],
      setPerUnit = _useState2[1];
  ...
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(0),
      _useState8 = _slicedToArray(_useState7, 2),
      unitKey = _useState8[0],
      setUnitKey = _useState8[1];
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_containers_MasterEdit__WEBPACK_IMPORTED_MODULE_0__["default"], {
    ...
    onOpen: function onOpen(data) {
      if (data) {
        if (data.qty_per_unit) {
          setPerUnit({
            id: data.qty_per_unit,
            name: data.qty_per_unit_name
          });
        }
    ...
    onSubmitSuccess: function onSubmitSuccess(request) {
      if (request.id == '') {
        setPerUnit(null);
      }
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_3__.CCol, {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_SearchSelect__WEBPACK_IMPORTED_MODULE_4__["default"], {
              ...
              onChange: function onChange(value) {
                setPerUnit(value);
                props.handleChange({
                  qty_unit: value ? value.id : ''
                });
              },
              invalid: props.isInvalid('qty_unit')
            }, "selectUnit_" + unitKey), props.feedback('qty_unit')]
          })]
        })]
      });
    }
