(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_currency_rates_CurrencyRateList_js"],{
...
var DTToolbarShow = function DTToolbarShow(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CButton, {
    className: "mr-2",
    color: "success",
    shape: "square",
    size: "sm",
...
var DTToolbarEdit = function DTToolbarEdit(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CButton, {
    ...
    shape: "square",
    size: "sm",
    disabled: (_props$disabled2 = props.disabled) !== null && _props$disabled2 !== void 0 ? _props$disabled2 : false,
    onClick: function onClick(event) {
...
var DTToolbarDelete = function DTToolbarDelete(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CButton, {
    ...
    shape: "square",
    size: "sm",
    disabled: (_props$disabled3 = props.disabled) !== null && _props$disabled3 !== void 0 ? _props$disabled3 : false,
    onClick: function onClick(event) {
...
var DTToolbar = function DTToolbar(props) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("td", {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CButtonToolbar, {
      children: [showButtonVisible ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(DTToolbarShow, {
        item: props.item,
        showAction: props.showAction,
        disabled: props.showButtonDisabled
      }) : '', editButtonVisible ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(DTToolbarEdit, {
        item: props.item,
        editAction: props.editAction,
        disabled: props.editButtonDisabled
      }) : '', deleteButtonVisible ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(DTToolbarDelete, {
        item: props.item,
...
var DTable = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(function (_ref, ref) {
  ...
  var initialParams = {
    page: (_tableData$page = tableData.page) !== null && _tableData$page !== void 0 ? _tableData$page : 1,
    limit: (_tableData$limit = tableData.limit) !== null && _tableData$limit !== void 0 ? _tableData$limit : 10,
    sort: tableData.sort,
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    var newFilter = _objectSpread(_objectSpread({}, params.filter), customFilter);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    var slots = {};
    var currentFields = props.fields;
    currentFields.map(function (field, index) {
...
/***/ "./resources/js/views/pages/currency_rates/CurrencyRateList.js":
/*!*********************************************************************!*\
  !*** ./resources/js/views/pages/currency_rates/CurrencyRateList.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CurrencyRateList = function CurrencyRateList() {
  var initialFilter = function initialFilter() {
    var _ref, _ref2;

    var tableData = JSON.parse(localStorage.getItem('datatable.currencyrateslist')) || {};
    return {
      start: (_ref = tableData.filter && tableData.filter.start) !== null && _ref !== void 0 ? _ref : '',
      end: (_ref2 = tableData.filter && tableData.filter.end) !== null && _ref2 !== void 0 ? _ref2 : '',
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(initialFilter()),
      _useState2 = _slicedToArray(_useState, 2),
      customFilter = _useState2[0],
      setCustomFilter = _useState2[1];

  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false),
      _useState4 = _slicedToArray(_useState3, 2),
      showInactive = _useState4[0],
      setShowInactive = _useState4[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
    setCustomFilter(_objectSpread(_objectSpread({}, customFilter), {}, {
      company_id: activeCompany.id
    }));
  }, [activeCompany]);
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
  ...
  var onChangeDate = function onChangeDate(type, event) {
    var value = event.target.value;
    var newFilter = {};
    newFilter[type] = value;
    setCustomFilter(_objectSpread(_objectSpread({}, customFilter), newFilter));
  };

  var customFilterInput = {
    start: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_1__.CInput, {
      type: "date",
      defaultValue: customFilter ? customFilter.start : '',
      "aria-label": "column name: 'start' filter input",
      onChange: function onChange(event) {
        return onChangeDate('start', event);
      },
      size: "sm"
    }),
    end: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_1__.CInput, {
      type: "date",
      defaultValue: customFilter ? customFilter.end : '',
      "aria-label": "column name: 'end' filter input",
      onChange: function onChange(event) {
        return onChangeDate('end', event);
      },
      size: "sm"
    })
  };

  var topSlot = function topSlot(_ref3) {
    var createButton = _ref3.createButton;
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
      children: [createButton, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("input", {
        onChange: function onChange(event) {
          return setShowInactive(event.target.checked);
        },
        className: "ml-4 mr-2",
        type: "checkbox"
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("span", {
        children: "Show Inactive Rates"
      })]
    });
  };

  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_containers_MasterList__WEBPACK_IMPORTED_MODULE_0__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CurrencyRateList);
