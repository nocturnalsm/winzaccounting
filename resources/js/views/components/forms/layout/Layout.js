        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/layout#form-grid">
              <CRow>
                <CCol xs>
                  <CInput placeholder="First name" aria-label="First name" />
                </CCol>
                <CCol xs>
                  <CInput placeholder="Last name" aria-label="Last name" />
                </CCol>
              </CRow>
            </DocsExample>
          </CCardBody>
            ...
            <DocsExample href="forms/layout#gutters">
              <CForm className="row g-3">
                <CCol md={6}>
                  ...
                  <CInput type="email" id="inputEmail4" />
                </CCol>
                <CCol md={6}>
                  <CFormLabel htmlFor="inputPassword4">Password</CFormLabel>
                  <CInput type="password" id="inputPassword4" />
                </CCol>
                <CCol xs={12}>
                  <CFormLabel htmlFor="inputAddress">Address</CFormLabel>
                  <CInput id="inputAddress" placeholder="1234 Main St" />
                </CCol>
                <CCol xs={12}>
                  <CFormLabel htmlFor="inputAddress2">Address 2</CFormLabel>
                  <CInput id="inputAddress2" placeholder="Apartment, studio, or floor" />
                </CCol>
                <CCol md={6}>
            ...
            <DocsExample href="forms/layout#horizontal-form">
              <CForm>
                <CRow className="mb-3">
                  ...
                  <CCol sm={10}>
                    <CInput type="email" id="inputEmail3" />
                  </CCol>
                </CRow>
                <CRow className="mb-3">
                  ...
                  <CCol sm={10}>
                    <CInput type="password" id="inputPassword3" />
                  </CCol>
                </CRow>
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/layout#horizontal-form-label-sizing">
              ...
              <CRow className="mb-3">
                ...
                <CCol sm={10}>
                  <CInput type="email" id="colFormLabel" placeholder="col-form-label" />
                </CCol>
              </CRow>
              <CRow>
                <CFormLabel
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/layout#column-sizing">
              <CRow className="g-3">
                <CCol sm={7}>
                  <CInput placeholder="City" aria-label="City" />
                </CCol>
                <CCol sm>
                  <CInput placeholder="State" aria-label="State" />
                </CCol>
                <CCol sm>
                  <CInput placeholder="Zip" aria-label="Zip" />
                </CCol>
              </CRow>
            </DocsExample>
          </CCardBody>
            ...
            <DocsExample href="forms/layout#auto-sizing">
              <CForm className="row gy-2 gx-3 align-items-center">
                <CCol xs="auto">
                  ...
                  <CInput id="autoSizingInput" placeholder="Jane Doe" />
                </CCol>
                <CCol xs="auto">
                  ...
                  <CInputGroup>
                    ...
                    <CInput id="autoSizingInputGroup" placeholder="Username" />
                  </CInputGroup>
                </CCol>
                <CCol xs="auto">
            ...
            <DocsExample href="forms/layout#auto-sizing">
              <CForm className="row gx-3 gy-2 align-items-center">
                <CCol sm={3}>
                  ...
                  <CInput id="specificSizeInputName" placeholder="Jane Doe" />
                </CCol>
                <CCol sm={3}>
                  ...
                  <CInputGroup>
                    <CInputGroupText>@</CInputGroupText>
                    <CInput id="specificSizeInputGroupUsername" placeholder="Username" />
                  </CInputGroup>
                </CCol>
                <CCol sm={3}>
            ...
            <DocsExample href="forms/layout#inline-forms">
              <CForm className="row row-cols-lg-auto g-3 align-items-center">
                <CCol xs={12}>
                  ...
                  <CInputGroup>
                    <CInputGroupText>@</CInputGroupText>
                    <CInput id="inlineFormInputGroupUsername" placeholder="Username" />
                  </CInputGroup>
                </CCol>
                <CCol xs={12}>
