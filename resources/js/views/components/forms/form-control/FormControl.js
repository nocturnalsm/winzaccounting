          ...
          <CCardBody>
            ...
            <DocsExample href="components/accordion">
              ...
              <CRow className="mb-3">
                ...
                <div className="col-sm-10">
                  <CInput type="password" id="inputPassword" />
                </div>
              </CRow>
            </DocsExample>
            <DocsExample href="components/accordion">
              <CForm className="row g-3">
                ...
                <div className="col-auto">
                  ...
                  <CInput type="password" id="inputPassword2" placeholder="Password" />
                </div>
                <div className="col-auto">
