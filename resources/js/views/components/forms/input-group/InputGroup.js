    ...
    <CRow>
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/input-group">
              ...
              <CInputGroup className="mb-3">
                ...
                <CInput id="basic-url" aria-describedby="basic-addon3" />
              </CInputGroup>
              <CInputGroup className="mb-3">
                <CInputGroupText>$</CInputGroupText>
                <CInput aria-label="Amount (to the nearest dollar)" />
                <CInputGroupText>.00</CInputGroupText>
              </CInputGroup>
              <CInputGroup className="mb-3">
                <CInput placeholder="Username" aria-label="Username" />
                <CInputGroupText>@</CInputGroupText>
                <CInput placeholder="Server" aria-label="Server" />
              </CInputGroup>
              <CInputGroup>
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/input-group#checkboxes-and-radios">
              <CInputGroup className="mb-3">
                ...
                <CInput aria-label="Text input with checkbox" />
              </CInputGroup>
              <CInputGroup>
                <CInputGroupText>
                  <CFormCheck
                ...
                <CInput aria-label="Text input with radio button" />
              </CInputGroup>
            </DocsExample>
          </CCardBody>
        </CCard>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              While multiple <code>&lt;CInput&gt;</code>s are supported visually, validation
            ...
            <DocsExample href="forms/input-group#multiple-inputs">
              <CInputGroup>
                ...
                <CInput aria-label="First name" />
                <CInput aria-label="Last name" />
              </CInputGroup>
            </DocsExample>
          </CCardBody>
        </CCard>
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/input-group#multiple-addons">
              <CInputGroup className="mb-3">
                ...
                <CInput aria-label="Dollar amount (with dot and two decimal places)" />
              </CInputGroup>
              <CInputGroup>
                <CInput aria-label="Dollar amount (with dot and two decimal places)" />
                <CInputGroupText>$</CInputGroupText>
          ...
          <CCardBody>
            ...
            <DocsExample href="forms/input-group#button-addons">
              ...
              <CInputGroup className="mb-3">
                ...
                <CInput placeholder="" aria-label="Example text with two button addons" />
              </CInputGroup>
              <CInputGroup>
                <CInput
                  placeholder="Recipient's username"
          ...
          <CCardBody>
            <DocsExample href="forms/input-group#buttons-with-dropdowns">
              <CInputGroup className="mb-3">
                ...
                <CInput aria-label="Text input with dropdown button" />
              </CInputGroup>
              <CInputGroup className="mb-3">
                <CInput aria-label="Text input with dropdown button" />
              ...
              <CInputGroup>
                ...
                <CInput aria-label="Text input with 2 dropdown buttons" />
                <CDropdown alignment="end" variant="input-group">
                  <CDropdownToggle color="secondary" variant="outline">
                    Dropdown
                  </CDropdownToggle>
          ...
          <CCardBody>
            <DocsExample href="forms/input-group#segmented-buttons">
              <CInputGroup className="mb-3">
                ...
                <CInput aria-label="Text input with segmented dropdown button" />
              </CInputGroup>
              <CInputGroup>
                <CInput aria-label="Text input with segmented dropdown button" />
                <CDropdown alignment="end" variant="input-group">
          ...
          <CCardBody>
            <DocsExample href="forms/input-group#custom-file-input">
              <CInputGroup className="mb-3">
                ...
                <CInput type="file" id="inputGroupFile01" />
              </CInputGroup>
              <CInputGroup className="mb-3">
                <CInput type="file" id="inputGroupFile02" />
