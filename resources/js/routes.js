...
const ProductEdit = React.lazy(() => import('./views/pages/products/ProductEdit'))
...
const routes = [
  ...
  */
  ...
  { path: '/products/create', name: 'Create Product', component: ProductEdit},
  { path: '/products/:id', name: 'Edit Product', component: ProductEdit},
